...
function NewEmployee() {
   ...
   /*----------------------------------*/
    ...
    var myWidget = window.cloudinary.createUploadWidget(
      {
        cloudName: VITE_APP_CLOUDINARY_CLOUD_NAME,
        uploadPreset: VITE_APP_CLOUDINARY_UPLOAD_PRESET,
   ...
   const yaExisteEmail = async()=> {
      ...
      const response = await axios.get(`${VITE_APP_API}/employees/${txtEmail}`, {
         headers: {
      ...
      if (!disabledAdd) {
         if (txtLevel && txtDepartment !== 'Choose...') {
               ...
               if ( await yaExisteEmail(txtEmail) ) {
                  ...
                  {
                  try {
                     const response = await axios.post(`${VITE_APP_API}/employees`,newEmployee, {
                        headers: {
                            "authorization": `Bearer ${userLogged.userToken}`,
                        }
                        });
...
validateForm();
  ...
  return (   
   <div className="d-flex mb-0 d-md-flex justify-content-center"  id = "containerEmployee">
      ...
      <CloudinaryContext cloudName= {VITE_APP_CLOUDINARY_CLOUD_NAME}>
